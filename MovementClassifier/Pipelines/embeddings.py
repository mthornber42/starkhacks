...
class EmbeddingsPipeline(Pipeline):
    ...
    def fit(self, dataset):
        ...
        self.autoencoder_, self.encoder_ = build_autoencoder(
            X_flat.shape[1], embedding_dim=self.embedding_dim
        )
        ...
        # Get embeddings
        X_emb = self.encoder_.predict(X_flat, verbose=0)
        ...
        # Save input dim
        self.input_dim_ = X_flat.shape[1]
        return self
    ...
    def transform(self, dataset):
        ...
        # Check input dim
        if X_flat.shape[1] != self.input_dim_:
